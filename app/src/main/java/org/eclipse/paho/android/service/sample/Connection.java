...
public class Connection {
  ...
  //==================
  public boolean isDisconnected() { return status == ConnectionStatus.DISCONNECTED; }
  public boolean isConnecting() { return status == ConnectionStatus.CONNECTING; }
  public boolean isDisconnecting() { return status == ConnectionStatus.DISCONNECTING; }
  public boolean isError() { return status == ConnectionStatus.ERROR; }
  public boolean isNone() { return status == ConnectionStatus.NONE; }
  //==================
