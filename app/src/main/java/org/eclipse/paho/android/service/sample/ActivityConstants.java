...
public class ActivityConstants {
  ...
  /*some String*/ //-------------------------------------------------------------------------
  static String cur_device = "";
  static String sw_state = "";
  static String on1 = "1:1";
  static String off1 = "1:0";
  static String on2 = "2:1";
  static String off2 = "2:0";
  static String on3 = "3:1";
  static String off3 = "3:0";
